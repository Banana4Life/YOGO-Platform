...
public class Loose extends Menu {
	...
	public void render(GameContainer container, StateBasedGame game, Graphics g)
		...
		this.game.fontHeader.drawString(game.getContainer().getWidth() / 2
				- this.game.fontHeader.getWidth("You lost your!") / 2, 10,
				"You lost your", Color.white);

		this.game.fontHeader.drawString(game.getContainer().getWidth() / 2
				- this.game.fontHeader.getWidth("ONLY") / 2, 70, "ONLY",
				Color.white);

		this.game.fontHeader.drawString(game.getContainer().getWidth() / 2
				- this.game.fontHeader.getWidth("platform") / 2, 130,

...
public class Credits extends BasicGameState {
    ...
    public int getHintY(String hint) {
        return (int) ((bikeDimensions.y) / 2) - (this.game.fontDefault.getHeight(hint) / 2);
    }
    ...
    public void render(GameContainer container, StateBasedGame game, Graphics g) throws SlickException {
        ...
        this.game.fontDefault.drawString(getColPixel(), getRowPixel(4), "A project developed for LudumDare 2013");
        this.game.fontDefault.drawString(getColPixel(), getRowPixel(5), "(see Http://ludumdare.com/ for more information)");
        /*
         * Easter EGG
         */
        g.drawAnimation(wheelAnim, bikePosition.x + 100 * bikeScale, bikePosition.y + 707f * bikeScale);
        // g.drawAnimation(wheelAnim, bikePosition.x + 1850 * bikeScale,
        // bikePosition.y + 707f * bikeScale);
        g.drawImage(moto, bikePosition.x - 300 * bikeScale, bikePosition.y - 360 * bikeScale);
    ...
    public void update(GameContainer container, StateBasedGame game, int delta) throws SlickException {
        ...
        if (!bikePaused) {
            ...
            if (bikePosition.x - getHintX(hint) - 10 > game.getContainer().getWidth()) {
                resetBike();
            } else if (bikePosition.x + bikeDimensions.x - 45 >= game.getContainer().getWidth() && !bikeWaited) {
                bikePaused = true;
                waitedFramesDrive = 0;
                waitToDrive = true;
                bikeWaited = true;
